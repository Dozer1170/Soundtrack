...
SOUNDTRACK_CLOSE_TIP = "Cierra la ventana principal de banda sonora. Si el tema estaba siendo visto de antemano que ser� detenido, y los eventos activos se reanudo."
...
SOUNDTRACK_EVENT_FILTER_TIP = "Permite filtrar los eventos. El filtro se compara con el nombre del evento. Desmarque la casilla para volver a mostrar la lista completa de eventos."
...
SOUNDTRACK_DOWN_TIP = "Mueve hacia abajo la cancion asignada, seleccione en la lista. Esto le permite establecer un orden espec�fico de sus canciones de evento."

SOUNDTRACK_UP = "Subir cancion"
SOUNDTRACK_UP_TIP = "Sube la cancion asignada, seleccione en la lista. Esto le permite establecer un orden espec�fico de sus canciones de evento."
...
SOUNDTRACK_SHOW_MINIMAP_BUTTON_TIP = "Muestra el icono de la banda sonora en el minimapa. El icono puede cambiar de posicion arrastr�ndolo todo el minimapa."
...
SOUNDTRACK_BUTTONS_PLAYBACK_CONTROLS_TIP = "Change location of the Playback Controls buttons around Playback Controls frame."
...
SOUNDTRACK_SHOW_DEBUG_TIP = "Salidas detallada informacion de depuracion en el marco del chat. Salida se env�a a marco de chat o el marco nombrado 'Soundtrack' si est� disponible."
...
SOUNDTRACK_ESCALATE_BATTLE_TIP = "Si durante una batalla se detecta a un enemigo m�s fuerte, permite que la musica para cambiar a la musica de batalla m�s alto."
...
SOUNDTRACK_ERROR_LOADING = "No se puede instalar MyTracks.lua. Probablemente se olvido de ejecutar GenerateMyLibrary.py. Lea las instrucciones de configuracion para m�s detalles."
