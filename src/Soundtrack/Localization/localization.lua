...
SOUNDTRACK_ADD_TARGET_TIP = "Add the currently targeted mob to the list, or enter the name of a mob to add to the list."
...
SOUNDTRACK_GEN_LIBRARY = "Exit the game, run GenerateMyLibrary, and reenter game to create MyTracks.lua for Soundtrack to work properly."
SOUNDTRACK_NO_MYTRACKS = "MyTracks.lua not found.\n\nRun Soundtrack without MyTracks.lua?"
SOUNDTRACK_ERROR_LOADING = "Cannot load MyTracks.lua. You probably forgot to run GenerateMyLibrary. Read the setup instructions for more details."
