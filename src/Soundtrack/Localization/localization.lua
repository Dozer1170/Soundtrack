...
local function ConcatLocalizationPath(spellId, path)
...
local function RegisterDruidStrings(localizedClassName, localizedChangeStanceText)
...
local function RegisterHunterStrings(localizedClassName)
  SOUNDTRACK_HUNTER = localizedClassName
  local camoPath = ConcatLocalizationPath(90954, localizedClassName .. "/")
  if not camoPath == nil then
    SOUNDTRACK_HUNTER_CAMO = camoPath
  end
end

local function RegisterDeathKnightStrings(localizedClassName, localizedChangeStanceText)
  SOUNDTRACK_DK = localizedClassName
  SOUNDTRACK_DK_CHANGE = localizedClassName .. "/" .. localizedChangeStanceText
end

local function RegisterEvokerStrings(localizedClassName)
  SOUNDTRACK_EVOKER = localizedClassName
  local soarPath = ConcatLocalizationPath(369536, localizedClassName .. "/")
  if not soarPath == nil then
    SOUNDTRACK_EVOKER_SOAR = soarPath
  end
end

local function RegisterPaladinStrings(localizedClassName, localizedChangeStanceText)
  SOUNDTRACK_PALADIN = localizedClassName
  SOUNDTRACK_PALADIN_CHANGE = localizedClassName .. "/" .. localizedChangeStanceText
end

local function RegisterPriestStrings(localizedClassName, localizedChangeStanceText)
  SOUNDTRACK_PRIEST = localizedClassName
  SOUNDTRACK_PRIEST_CHANGE = localizedClassName .. "/" .. localizedChangeStanceText
end

local function RegisterRogueStrings(localizedClassName, localizedChangeStanceText)
...
local function RegisterShamanStrings(localizedClassName, localizedChangeStanceText)
  ...
  local ghostWolfPath = ConcatLocalizationPath(2645, shamanPath)
  if not ghostWolfPath == nil then
    SOUNDTRACK_SHAMAN_GHOST_WOLF = ghostWolfPath
  end
end

local function RegisterWarriorStrings(localizedClassName, localizedChangeStanceText)
...
if not LOCALIZATION_LOADED then
  ...
  RegisterHunterStrings("Hunter")
  RegisterDeathKnightStrings("Death Knight", "Change Presence")
  RegisterEvokerStrings("Evoker")
  RegisterPaladinStrings("Paladin", "Change Aura")
  RegisterPriestStrings("Priest", "Change Form")
  RegisterRogueStrings("Rogue", "Change Stealth")
  RegisterShamanStrings("Shaman", "Change Form")
  RegisterWarriorStrings("Warrior", "Change Stance")
