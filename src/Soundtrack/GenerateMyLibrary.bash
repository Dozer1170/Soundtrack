...
function parse_id3v2 {
  while [ -n "$1" ]; do
    ...
    if [ "$id3v2_sig" = "ID3" ]; then
      ...
      while [ $i -lt $id3v2_size_characters ]; do
        ...
        if [ -z "$frame_id" ] || [ "$frame_size" -eq 0 ]; then
