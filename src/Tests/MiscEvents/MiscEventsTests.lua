...
function Tests:DruidEvents_Register_AddsBuffEvents()
  ...
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_DRUID])
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_DRUID_DASH])
  Exists(Soundtrack.Misc.UpdateScripts[SOUNDTRACK_DRUID_PROWL])
end
...
function Tests:NpcEvents_Register_AddsAllNpcEvents()
  ...
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_NPC_EMOTE])
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_NPC_SAY])
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_NPC_WHISPER])
  Exists(Soundtrack_MiscEvents[SOUNDTRACK_NPC_YELL])
end
...
function Tests:StealthEvents_Register_SetsUpdateScripts()
  ...
  Exists(Soundtrack.Misc.UpdateScripts[SOUNDTRACK_ROGUE_STEALTH])
  Exists(Soundtrack.Misc.UpdateScripts[SOUNDTRACK_STEALTHED])
end
